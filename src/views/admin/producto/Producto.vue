<template>
  <div>
        ...
        <Column header="imagen">
          <template #body="slotProps">
            <img
              ...
              :src="`https://127.0.0.1:8000/${slotProps.data.imagen}`"
    ...
    >
      <img
        :src="`https://127.0.0.1:8000/${slotProps.producto.imagen}`"
        :alt="producto.imagen"
        class="product-image"
  ...
  methods: {
    ...
    async saveProduct() {
      ...
      if (this.producto.nombre.trim()) {
        if (this.producto.id) {
          this.producto.estado = this.producto.inventoryStatus.value
            ? this.producto.inventoryStatus.value
            : this.producto.inventoryStatus;
